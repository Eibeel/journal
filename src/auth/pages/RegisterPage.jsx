...
export const RegisterPage = () => {
  ...
  // validamos status y desahibilitamos botones de autenticacion
  const isCheckingValidation = useMemo(() => status === 'checking', [status])
      ...
      <form onSubmit={onSubmit} className='animate__animated animate__fadeIn animate__faster'>
        <Grid container>
          ...
          <Grid container spacing={2} sx={{ mb: 2, mt: 1 }}>
            ...
            <Grid item xs={12}>
              <Button disabled={isCheckingValidation} type='submit' variant='contained' fullWidth>
                Crear cuenta
              </Button>
            </Grid>
          </Grid>
